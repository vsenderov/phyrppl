 ...
 *      shits are drawn (both anagenetic and cladogenetic)
 *
 *    - uncoupling of the turnover and anagenesis rates at the rare
 *        shifts points
 *
 ...
 *
 *    const floating_t epsilon = 0.5;    // rescaling for μ
 *    const floating_t ypsilon = 0.5;    // rescaling for ν
 *
 ...
 *    const floating_t b = 0.2*10e-3;  // Hyper-param of prior for α and σ
 *
 *    // Hyper-param of prior for α and σ (large)
 *    const floating_t m0_rare = 0;   
 *    const floating_t v_rare = 1;    // Hyper-param of prior for α and σ
 *    const floating_t a_rare = 1.0;  // Hyper-param of prior for α and σ
 *    const floating_t b_rare = 0.2;  // Hyper-param of prior for α and σ
 * 
...
/* Common shift prior (new) */
const floating_t m0 = 0;
const floating_t v = 1;
const floating_t a = 1.0;
const floating_t b = 0.2*10e-3;

/* Rare shift priors (concept) */
const floating_t m0_rare = 0;
