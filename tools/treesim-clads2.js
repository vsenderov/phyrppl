...
var main = (function (_globalCurrentAddress) {
    return function (p) {
        ...
        var clads2TreeSimulate = function clads2TreeSimulate(globalStore, _k325, _address251, startTime, lambda0, logAlpha, sigma, epsilon, rho, max_R) {
            var _currentAddress = _address251;
            _addr.save(_globalCurrentAddress, _address251);
            return function () {
                return clads2TreeSim(globalStore, function (globalStore, Tree) {
                    _addr.save(_globalCurrentAddress, _currentAddress);
                    var _k330 = function (globalStore, _dummy329) {
                        _addr.save(_globalCurrentAddress, _currentAddress);
                        var stringTree = Tree.join('');
                        return function () {
                            return stringTree.includes('ERROR_MAX') ? function (globalStore, message) {
                                _addr.save(_globalCurrentAddress, _currentAddress);
                                var _dummy326 = fs.write(filename, message);
                                return function () {
                                    return _k325(globalStore, message);
                                };
                            }(globalStore, 'Guards hit. Tree too big.') : stringTree.includes('ERROR_ZERO') ? function (globalStore, message) {
                                _addr.save(_globalCurrentAddress, _currentAddress);
                                var _dummy327 = fs.write(filename, message);
                                return function () {
                                    return _k325(globalStore, message);
                                };
                            }(globalStore, 'Guards hit. Evolution stopped.') : function (globalStore, Tree) {
                                _addr.save(_globalCurrentAddress, _currentAddress);
                                var _dummy328 = fs.write(filename, Tree);
                                return function () {
                                    return _k325(globalStore, Tree);
                                };
                    ...
                    return function () {
                        return ad.scalar.eq(Tree, !1) ? function (globalStore, message) {
                            _addr.save(_globalCurrentAddress, _currentAddress);
                            var _dummy331 = fs.write(filename, message);
                            return function () {
                                return _k325(globalStore, message);
                            };
                        }(globalStore, 'No survivors.') : _k330(globalStore, undefined);
                    };
                }, _address251.concat('_624'), startTime, lambda0, logAlpha, sigma, epsilon, rho, max_R);
            };
        };
        var clads2TreeSim = function clads2TreeSim(globalStore, _k290, _address252, startTime, lambda, logAlpha, sigma, epsilon, rho, max_R) {
            var _currentAddress = _address252;
            _addr.save(_globalCurrentAddress, _address252);
            var mu = ad.scalar.mul(epsilon, lambda);
            var _k324 = function (globalStore, _dummy323) {
                _addr.save(_globalCurrentAddress, _currentAddress);
                var _k322 = function (globalStore, _dummy321) {
                    _addr.save(_globalCurrentAddress, _currentAddress);
                    var _k320 = function (globalStore, _dummy319) {
                        _addr.save(_globalCurrentAddress, _currentAddress);
                        var _k316 = function (globalStore, _dummy315) {
                            _addr.save(_globalCurrentAddress, _currentAddress);
                            var _k314 = function (globalStore, _dummy313) {
                                _addr.save(_globalCurrentAddress, _currentAddress);
                                return function () {
                                    return exponential(globalStore, function (globalStore, t) {
                                        ...
                                        var _k310 = function (globalStore, _dummy309) {
                                            _addr.save(_globalCurrentAddress, _currentAddress);
                                            return function () {
                                                return flip(globalStore, function (globalStore, extinction) {
                                                    _addr.save(_globalCurrentAddress, _currentAddress);
                                                    var _k308 = function (globalStore, _dummy307) {
                                                        _addr.save(_globalCurrentAddress, _currentAddress);
                                                        return function () {
                                                            return gaussian(globalStore, function (globalStore, _result306) {
                                                                _addr.save(_globalCurrentAddress, _currentAddress);
                                                                var multip1 = ad.scalar.exp(_result306);
                                                                return function () {
                                                                    return gaussian(globalStore, function (globalStore, _result305) {
                                                                        _addr.save(_globalCurrentAddress, _currentAddress);
                                                                        var multip2 = ad.scalar.exp(_result305);
                                                                        var lambda1 = ad.scalar.mul(lambda, multip1);
                                                                        var lambda2 = ad.scalar.mul(lambda, multip2);
                                                                        return function () {
                                                                            return clads2TreeSim(globalStore, function (globalStore, leftTree) {
                                                                                _addr.save(_globalCurrentAddress, _currentAddress);
                                                                                var _k302 = function (globalStore, _dummy301) {
                                                                                    _addr.save(_globalCurrentAddress, _currentAddress);
                                                                                    return function () {
                                                                                        return clads2TreeSim(globalStore, function (globalStore, rightTree) {
                                                                                            _addr.save(_globalCurrentAddress, _currentAddress);
                                                                                            var _k298 = function (globalStore, _dummy297) {
                                                                                                _addr.save(_globalCurrentAddress, _currentAddress);
                                                                                                var _k294 = function (globalStore, _dummy293) {
                                                                                                    _addr.save(_globalCurrentAddress, _currentAddress);
                                                                                                    var _k292 = function (globalStore, _dummy291) {
                                                                                                        _addr.save(_globalCurrentAddress, _currentAddress);
                                                                                                        return function () {
                                                                                                            return ad.scalar.eq(leftTree, !1) ? function (globalStore, newBranch) {
                                                                                                                ...
                                                                                                                return function () {
                                                                                                                    return _k290(globalStore, NewickTree);
                                                                                                                };
                                                                                                    ...
                                                                                                    return function () {
                                                                                                        ...
                                                                                                        }(globalStore, ad.scalar.add(leftTree[1], internalBranch)) : _k292(globalStore, undefined);
                                                                                                    };
                                                                                                };
                                                                                                var _k296 = function (globalStore, _result295) {
                                                                                                    _addr.save(_globalCurrentAddress, _currentAddress);
                                                                                                    return function () {
                                                                                                        return _result295 ? _k290(globalStore, !1) : _k294(globalStore, undefined);
                                                                                                    };
                                                                                                };
                                                                                                return function () {
                                                                                                    return ad.scalar.eq(leftTree, !1) ? _k296(globalStore, ad.scalar.eq(rightTree, !1)) : _k296(globalStore, ad.scalar.eq(leftTree, !1));
                                                                                                };
                                                                                            };
                                                                                            var _k300 = function (globalStore, _result299) {
                                                                                                _addr.save(_globalCurrentAddress, _currentAddress);
                                                                                                return function () {
                                                                                                    return _result299 ? _k290(globalStore, rightTree) : _k298(globalStore, undefined);
                                                                                                };
                                                                                            };
                                                                                            return function () {
                                                                                                return rightTree ? checkError(globalStore, _k300, _address252.concat('_633'), rightTree) : _k300(globalStore, rightTree);
                                                                                            };
                                                                                        }, _address252.concat('_632'), currentTime, lambda2, logAlpha, sigma, epsilon, rho, ad.scalar.sub(max_R, 1));
                                                                                    };
                                                                                };
                                                                                var _k304 = function (globalStore, _result303) {
                                                                                    _addr.save(_globalCurrentAddress, _currentAddress);
                                                                                    return function () {
                                                                                        return _result303 ? _k290(globalStore, leftTree) : _k302(globalStore, undefined);
                                                                                    };
                                                                                };
                                                                                return function () {
                                                                                    return leftTree ? checkError(globalStore, _k304, _address252.concat('_631'), leftTree) : _k304(globalStore, leftTree);
                                                                                };
                                                                            }, _address252.concat('_630'), currentTime, lambda1, logAlpha, sigma, epsilon, rho, ad.scalar.sub(max_R, 1));
                                                                        };
                                                                    }, _address252.concat('_629'), {
                                                                        mu: logAlpha,
                                                                        sigma: sigma
                                                                    });
                                                                };
                                                            }, _address252.concat('_628'), {
                                                                mu: logAlpha,
                                                                sigma: sigma
                                                            });
                                                        };
                                                    ...
                                                    return function () {
                                                        return extinction ? _k290(globalStore, !1) : _k308(globalStore, undefined);
                                                    };
                                                }, _address252.concat('_627'), ad.scalar.div(mu, ad.scalar.add(mu, lambda)));
                                            };
                                        };
                                        return function () {
                                            return ad.scalar.lt(currentTime, 0) ? function (globalStore, _dummy312) {
                                                _addr.save(_globalCurrentAddress, _currentAddress);
                                                return function () {
                                                    return flip(globalStore, function (globalStore, _result311) {
                                                        _addr.save(_globalCurrentAddress, _currentAddress);
                                                        return function () {
                                                            return _result311 ? function (globalStore, Label) {
                                                                _addr.save(_globalCurrentAddress, _currentAddress);
                                                                var NewickTree = [
                                                                    Label,
                                                                    startTime
                                                            ...
                                                            }(globalStore, ad.scalar.add(ad.scalar.add('Taxon_', globalStore.n), ':')) : _k290(globalStore, !1);
                                                        };
                                                    }, _address252.concat('_626'), rho);
                                                };
                                            }(globalStore, globalStore.n = ad.scalar.add(globalStore.n, 1)) : _k310(globalStore, undefined);
                                        };
                                    }, _address252.concat('_625'), { a: ad.scalar.add(lambda, mu) });
                                };
                            };
                            return function () {
                                return ad.scalar.gt(globalStore.n, MAX_NODES) ? _k290(globalStore, [
                                    'ERROR_MAX_TAXA:',
                                    startTime
                                ]) : _k314(globalStore, undefined);
                            };
                        };
                        var _k318 = function (globalStore, _result317) {
                            _addr.save(_globalCurrentAddress, _currentAddress);
                            return function () {
                                return _result317 ? _k290(globalStore, [
                                    'ERROR_ZERO:',
                                    startTime
                                ]) : _k316(globalStore, undefined);
                            };
                        };
                        return function () {
                            return ad.scalar.eq(lambda, 0) ? _k318(globalStore, ad.scalar.eq(lambda, 0)) : _k318(globalStore, ad.scalar.eq(mu, 0));
                        };
                    };
                    return function () {
                        return ad.scalar.gt(ad.scalar.sub(lambda, mu), MAX_DIV) ? _k290(globalStore, [
                            'ERROR_MAX_DIV:',
                            startTime
                        ]) : _k320(globalStore, undefined);
                    };
                };
                return function () {
                    return ad.scalar.gt(lambda, MAX_LAMBDA) ? _k290(globalStore, [
                        'ERROR_MAX_LAMBDA:',
                        startTime
                    ]) : _k322(globalStore, undefined);
                };
            };
            return function () {
                return ad.scalar.eq(max_R, 0) ? _k290(globalStore, [
                    'ERROR_MAX_RECURSION:',
                    startTime
                ]) : _k324(globalStore, undefined);
            };
        };
        ...
        var clads2TreeSimulate = function clads2TreeSimulate(globalStore, _k36, _address267, dirname) {
            ...
            return function () {
                return getHyperParamsFromDir(globalStore, function (globalStore, obj) {
                    ...
                    return function () {
                        return clads2TreeSim(globalStore, function (globalStore, TreeLeft) {
                            _addr.save(_globalCurrentAddress, _currentAddress);
                            return function () {
                                return ad.scalar.eq(TreeLeft, !1) ? function (globalStore, _dummy38) {
                                    ...
                                    return function () {
                                        return clads2TreeSimulate(globalStore, _k36, _address267.concat('_698'), dirname);
                                    };
                                    ...
                                    var _k48 = function (globalStore, _result39) {
                                        ...
                                        return function () {
                                            return _result39 ? function (globalStore, _dummy41) {
                                                ...
                                                return function () {
                                                    return clads2TreeSimulate(globalStore, _k36, _address267.concat('_699'), dirname);
                                                };
                                            }(globalStore, console.log('Error: Guards hit')) : clads2TreeSim(globalStore, function (globalStore, TreeRight) {
                                                _addr.save(_globalCurrentAddress, _currentAddress);
                                                return function () {
                                                    return ad.scalar.eq(TreeRight, !1) ? function (globalStore, _dummy43) {
                                                        ...
                                                        return function () {
                                                            return clads2TreeSimulate(globalStore, _k36, _address267.concat('_701'), dirname);
                                                        };
                                                        ...
                                                        var _k47 = function (globalStore, _result44) {
                                                            ...
                                                            return function () {
                                                                return _result44 ? function (globalStore, _dummy46) {
                                                                    ...
                                                                    return function () {
                                                                        return clads2TreeSimulate(globalStore, _k36, _address267.concat('_702'), dirname);
                                                                    };
        ...
        var clads2TreeSim = function clads2TreeSim(globalStore, _k1, _address268, startTime, lambda, logAlpha, sigma, epsilon, rho, max_R, MAX_LAMBDA, MAX_NODES, MAX_DIV) {
                                                                ...
                                                                return function () {
                                                                    return gaussian(globalStore, function (globalStore, _result16) {
                                                                        ...
                                                                        return function () {
                                                                            return clads2TreeSim(globalStore, function (globalStore, leftTree) {
                                                                                ...
                                                                                var _k13 = function (globalStore, _dummy12) {
                                                                                    ...
                                                                                    return function () {
                                                                                        ...
                                                                                        }, _address268.concat('_710'), currentTime, lambda2, logAlpha, sigma, epsilon, rho, ad.scalar.sub(max_R, 1), MAX_LAMBDA, MAX_NODES, MAX_DIV);
                                                                                    };
                                                                                };
                                                                            ...
                                                                            }, _address268.concat('_708'), currentTime, lambda1, logAlpha, sigma, epsilon, rho, ad.scalar.sub(max_R, 1), MAX_LAMBDA, MAX_NODES, MAX_DIV);
                                                                        };
        ...
        return function () {
            return clads2TreeSimulate(globalStore, _k0, _address0.concat('_712'), dirname);
        };
    });
});
