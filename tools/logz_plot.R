...
################################################################################
plot_logz_directory_violin = function(experiment_dir, xvar = "step", plotf = "plot.svg", title, model)
{
  experiment_files = list.files(experiment_dir)
  experiment_metadata = cbind(metadata_from_dir(experiment_dir), model = model)
