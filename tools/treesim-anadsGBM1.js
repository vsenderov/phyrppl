...
var main = (function (_globalCurrentAddress) {
    return function (p) {
        ...
        var anads1TreeSimulate = function anads1TreeSimulate(globalStore, _k133, _address261, startTime, lambda0, stepsize, logAlpha, sigma, mu, rho, max_R) {
            var _currentAddress = _address261;
            _addr.save(_globalCurrentAddress, _address261);
            return function () {
                return anads1TreeSim(globalStore, function (globalStore, Tree) {
                    _addr.save(_globalCurrentAddress, _currentAddress);
                    var _k138 = function (globalStore, _dummy137) {
                        ...
                        return function () {
                            return stringTree.includes('ERROR_MAX') ? function (globalStore, message) {
                                _addr.save(_globalCurrentAddress, _currentAddress);
                                var _dummy134 = fs.write(filename, message);
                                return function () {
                                    return _k133(globalStore, message);
                                };
                            }(globalStore, 'Guards hit. Tree too big.') : stringTree.includes('ERROR_ZERO') ? function (globalStore, message) {
                                _addr.save(_globalCurrentAddress, _currentAddress);
                                var _dummy135 = fs.write(filename, message);
                                return function () {
                                    return _k133(globalStore, message);
                                };
                            }(globalStore, 'Guards hit. Evolution stopped.') : function (globalStore, Tree) {
                                _addr.save(_globalCurrentAddress, _currentAddress);
                                var _dummy136 = fs.write(filename, Tree);
                                return function () {
                                    return _k133(globalStore, Tree);
                                };
                    ...
                    return function () {
                        return ad.scalar.eq(Tree, !1) ? function (globalStore, message) {
                            _addr.save(_globalCurrentAddress, _currentAddress);
                            var _dummy139 = fs.write(filename, message);
                            return function () {
                                return _k133(globalStore, message);
                            };
                        }(globalStore, 'No survivors.') : _k138(globalStore, undefined);
                    };
                }, _address261.concat('_673'), startTime, lambda0, stepsize, logAlpha, sigma, mu, rho, max_R);
            };
        };
        var anads1TreeSim = function anads1TreeSim(globalStore, _k94, _address262, startTime, lambda, stepsize, logAlpha, sigma, mu, rho, max_R) {
            var _currentAddress = _address262;
            _addr.save(_globalCurrentAddress, _address262);
                                    ...
                                    return exponential(globalStore, function (globalStore, timeToSpeciation) {
                                        ...
                                        return function () {
                                            return exponential(globalStore, function (globalStore, timeToExtinction) {
                                                ...
                                                var _k120 = function (globalStore, _result95) {
                                                    _addr.save(_globalCurrentAddress, _currentAddress);
                                                    return function () {
                                                        return _result95 ? function (globalStore, currentTime) {
                                                            _addr.save(_globalCurrentAddress, _currentAddress);
                                                            var _k98 = function (globalStore, _dummy97) {
                                                                _addr.save(_globalCurrentAddress, _currentAddress);
                                                                var internalBranch = timeToAnagenesis;
                                                                return function () {
                                                                    return gaussian(globalStore, function (globalStore, _result96) {
                                                                        _addr.save(_globalCurrentAddress, _currentAddress);
                                                                        var multip = ad.scalar.exp(_result96);
                                                                        var lambdaNew = ad.scalar.mul(lambda, multip);
                                                                        return function () {
                                                                            return anads1TreeSim(globalStore, function (globalStore, Tree) {
                                                                                _addr.save(_globalCurrentAddress, _currentAddress);
                                                                                return function () {
                                                                                    return ad.scalar.eq(Tree, !1) ? _k94(globalStore, !1) : function (globalStore, newBranch) {
                                                                                        _addr.save(_globalCurrentAddress, _currentAddress);
                                                                                        var NewickTree = [
                                                                                            Tree[0],
                                                                                            newBranch
                                                                                        ...
                                                                                        return function () {
                                                                                            return _k94(globalStore, NewickTree);
                                                                                        };
                                                                                    }(globalStore, ad.scalar.add(Tree[1], internalBranch));
                                                                                };
                                                                            }, _address262.concat('_678'), currentTime, lambdaNew, stepsize, logAlpha, sigma, mu, rho, ad.scalar.sub(max_R, 1));
                                                                        };
                                                                    }, _address262.concat('_677'), {
                                                            ...
                                                            return function () {
                                                                return ad.scalar.lt(currentTime, 0) ? function (globalStore, _dummy100) {
                                                                    _addr.save(_globalCurrentAddress, _currentAddress);
                                                                    return function () {
                                                                        return flip(globalStore, function (globalStore, _result99) {
                                                                            _addr.save(_globalCurrentAddress, _currentAddress);
                                                                            return function () {
                                                                                return _result99 ? function (globalStore, Label) {
                                                                                    _addr.save(_globalCurrentAddress, _currentAddress);
                                                                                    var NewickTree = [
                                                                                        Label,
                                                                                        startTime
                                                                                ...
                                                                                }(globalStore, ad.scalar.add(ad.scalar.add('Taxon_', globalStore.n), ':')) : _k94(globalStore, !1);
                                                                            };
                                                                        }, _address262.concat('_676'), rho);
                                                                    };
                                                                }(globalStore, globalStore.n = ad.scalar.add(globalStore.n, 1)) : _k98(globalStore, undefined);
                                                            };
                                                            ...
                                                            var _k117 = function (globalStore, _dummy116) {
                                                                _addr.save(_globalCurrentAddress, _currentAddress);
                                                                return function () {
                                                                    return ad.scalar.eq(timeToExtinction, timeToEvent) ? _k94(globalStore, !1) : function (globalStore, delta) {
                                                                        _addr.save(_globalCurrentAddress, _currentAddress);
                                                                        return function () {
                                                                            return gaussian(globalStore, function (globalStore, _result115) {
                                                                                _addr.save(_globalCurrentAddress, _currentAddress);
                                                                                var multip = ad.scalar.exp(_result115);
                                                                                var lambdaNew = ad.scalar.mul(lambda, multip);
                                                                                return function () {
                                                                                    return anads1TreeSim(globalStore, function (globalStore, leftTree) {
                                                                                        _addr.save(_globalCurrentAddress, _currentAddress);
                                                                                        var _k112 = function (globalStore, _dummy111) {
                                                                                            _addr.save(_globalCurrentAddress, _currentAddress);
                                                                                            return function () {
                                                                                                return anads1TreeSim(globalStore, function (globalStore, rightTree) {
                                                                                                    _addr.save(_globalCurrentAddress, _currentAddress);
                                                                                                    var _k108 = function (globalStore, _dummy107) {
                                                                                                        _addr.save(_globalCurrentAddress, _currentAddress);
                                                                                                        var _k104 = function (globalStore, _dummy103) {
                                                                                                            _addr.save(_globalCurrentAddress, _currentAddress);
                                                                                                            ...
                                                                                                            return function () {
                                                                                                                ...
                                                                                                                }(globalStore, ad.scalar.add(leftTree[1], internalBranch)) : _k102(globalStore, undefined);
                                                                                                            };
                                                                                                        };
                                                                                                        var _k106 = function (globalStore, _result105) {
                                                                                                            _addr.save(_globalCurrentAddress, _currentAddress);
                                                                                                            return function () {
                                                                                                                return _result105 ? _k94(globalStore, !1) : _k104(globalStore, undefined);
                                                                                                            };
                                                                                                        };
                                                                                                        return function () {
                                                                                                            return ad.scalar.eq(leftTree, !1) ? _k106(globalStore, ad.scalar.eq(rightTree, !1)) : _k106(globalStore, ad.scalar.eq(leftTree, !1));
                                                                                                        };
                                                                                                    };
                                                                                                    var _k110 = function (globalStore, _result109) {
                                                                                                        _addr.save(_globalCurrentAddress, _currentAddress);
                                                                                                        return function () {
                                                                                                            return _result109 ? _k94(globalStore, rightTree) : _k108(globalStore, undefined);
                                                                                                        };
                                                                                                    };
                                                                                                    return function () {
                                                                                                        return rightTree ? checkError(globalStore, _k110, _address262.concat('_684'), rightTree) : _k110(globalStore, rightTree);
                                                                                                    };
                                                                                                }, _address262.concat('_683'), currentTime, lambdaNew, stepsize, logAlpha, sigma, mu, rho, ad.scalar.sub(max_R, 1));
                                                                                            };
                                                                                        };
                                                                                        var _k114 = function (globalStore, _result113) {
                                                                                            _addr.save(_globalCurrentAddress, _currentAddress);
                                                                                            return function () {
                                                                                                return _result113 ? _k94(globalStore, leftTree) : _k112(globalStore, undefined);
                                                                                            };
                                                                                        };
                                                                                        return function () {
                                                                                            return leftTree ? checkError(globalStore, _k114, _address262.concat('_682'), leftTree) : _k114(globalStore, leftTree);
                                                                                        };
                                                                                    }, _address262.concat('_681'), currentTime, lambdaNew, stepsize, logAlpha, sigma, mu, rho, ad.scalar.sub(max_R, 1));
                                                                                };
                                                                            }, _address262.concat('_680'), {
                                                            ...
                                                            return function () {
                                                                return ad.scalar.lt(currentTime, 0) ? function (globalStore, _dummy119) {
                                                                    _addr.save(_globalCurrentAddress, _currentAddress);
                                                                    return function () {
                                                                        return flip(globalStore, function (globalStore, _result118) {
                                                                            _addr.save(_globalCurrentAddress, _currentAddress);
                                                                            return function () {
                                                                                return _result118 ? function (globalStore, Label) {
                                                                                    _addr.save(_globalCurrentAddress, _currentAddress);
                                                                                    var NewickTree = [
                                                                                        Label,
                                                                                        startTime
                                                                        ...
                                                                        }, _address262.concat('_679'), rho);
                                                                    };
                                                                }(globalStore, globalStore.n = ad.scalar.add(globalStore.n, 1)) : _k117(globalStore, undefined);
                                                            };
                                                        }(globalStore, ad.scalar.min(timeToSpeciation, timeToExtinction));
                                                    };
                                                };
                                                return function () {
                                                    return ad.scalar.lt(timeToAnagenesis, timeToSpeciation) ? _k120(globalStore, ad.scalar.lt(timeToAnagenesis, timeToExtinction)) : _k120(globalStore, ad.scalar.lt(timeToAnagenesis, timeToSpeciation));
                                                };
                                            }, _address262.concat('_675'), { a: mu });
                                        };
                                    }, _address262.concat('_674'), { a: lambda });
                                };
                            };
                            return function () {
                                return ad.scalar.gt(globalStore.n, MAX_NODES) ? _k94(globalStore, [
                                    'ERROR_MAX_TAXA:',
                                    startTime
                                ]) : _k122(globalStore, undefined);
                            };
                        };
                        var _k126 = function (globalStore, _result125) {
                            _addr.save(_globalCurrentAddress, _currentAddress);
                            return function () {
                                return _result125 ? _k94(globalStore, [
                                    'ERROR_ZERO:',
                                    startTime
                                ]) : _k124(globalStore, undefined);
                            };
                        };
                        return function () {
                            return ad.scalar.eq(lambda, 0) ? _k126(globalStore, ad.scalar.eq(lambda, 0)) : _k126(globalStore, ad.scalar.eq(mu, 0));
                        };
                    };
                    return function () {
                        return ad.scalar.gt(ad.scalar.sub(lambda, mu), MAX_DIV) ? _k94(globalStore, [
                            'ERROR_MAX_DIV:',
                            startTime
                        ]) : _k128(globalStore, undefined);
                    };
                };
                return function () {
                    return ad.scalar.gt(lambda, MAX_LAMBDA) ? _k94(globalStore, [
                        'ERROR_MAX_LAMBDA:',
                        startTime
                    ]) : _k130(globalStore, undefined);
                };
            };
            return function () {
                return ad.scalar.eq(max_R, 0) ? _k94(globalStore, [
                    'ERROR_MAX_RECURSION:',
                    startTime
                ]) : _k132(globalStore, undefined);
            };
        };
        ...
        var anads1TreeSimulate = function anads1TreeSimulate(globalStore, _k40, _address267, dirname) {
            ...
            return function () {
                return getHyperParamsFromDir(globalStore, function (globalStore, obj) {
                    ...
                    return function () {
                        return anads1TreeSim(globalStore, function (globalStore, TreeLeft) {
                            _addr.save(_globalCurrentAddress, _currentAddress);
                            return function () {
                                return ad.scalar.eq(TreeLeft, !1) ? function (globalStore, _dummy42) {
                                    ...
                                    return function () {
                                        return anads1TreeSimulate(globalStore, _k40, _address267.concat('_698'), dirname);
                                    };
                                    ...
                                    var _k52 = function (globalStore, _result43) {
                                        ...
                                        return function () {
                                            return _result43 ? function (globalStore, _dummy45) {
                                                ...
                                                return function () {
                                                    return anads1TreeSimulate(globalStore, _k40, _address267.concat('_699'), dirname);
                                                };
                                            }(globalStore, console.log('Error: Guards hit')) : anads1TreeSim(globalStore, function (globalStore, TreeRight) {
                                                _addr.save(_globalCurrentAddress, _currentAddress);
                                                return function () {
                                                    return ad.scalar.eq(TreeRight, !1) ? function (globalStore, _dummy47) {
                                                        ...
                                                        return function () {
                                                            return anads1TreeSimulate(globalStore, _k40, _address267.concat('_701'), dirname);
                                                        };
                                                        ...
                                                        var _k51 = function (globalStore, _result48) {
                                                            ...
                                                            return function () {
                                                                return _result48 ? function (globalStore, _dummy50) {
                                                                    ...
                                                                    return function () {
                                                                        return anads1TreeSimulate(globalStore, _k40, _address267.concat('_702'), dirname);
                                                                    };
        ...
        var anads1TreeSim = function anads1TreeSim(globalStore, _k1, _address268, startTime, lambda, stepsize, logAlpha, sigma, mu, rho, max_R, MAX_LAMBDA, MAX_NODES, MAX_DIV) {
                                                                ...
                                                                return function () {
                                                                    return gaussian(globalStore, function (globalStore, _result3) {
                                                                        ...
                                                                        return function () {
                                                                            ...
                                                                            }, _address268.concat('_707'), currentTime, lambdaNew, stepsize, logAlpha, sigma, mu, rho, ad.scalar.sub(max_R, 1), MAX_LAMBDA, MAX_NODES, MAX_DIV);
                                                                        };
                                                                        ...
                                                                        return function () {
                                                                            return gaussian(globalStore, function (globalStore, _result22) {
                                                                                ...
                                                                                return function () {
                                                                                    return anads1TreeSim(globalStore, function (globalStore, leftTree) {
                                                                                        ...
                                                                                        var _k19 = function (globalStore, _dummy18) {
                                                                                            ...
                                                                                            return function () {
                                                                                                ...
                                                                                                }, _address268.concat('_712'), currentTime, lambdaNew, stepsize, logAlpha, sigma, mu, rho, ad.scalar.sub(max_R, 1), MAX_LAMBDA, MAX_NODES, MAX_DIV);
                                                                                            };
                                                                                        };
                                                                                    ...
                                                                                    }, _address268.concat('_710'), currentTime, lambdaNew, stepsize, logAlpha, sigma, mu, rho, ad.scalar.sub(max_R, 1), MAX_LAMBDA, MAX_NODES, MAX_DIV);
                                                                                };
        ...
        return function () {
            return anads1TreeSimulate(globalStore, _k0, _address0.concat('_714'), dirname);
        };
    });
});
